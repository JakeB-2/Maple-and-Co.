...
export const entityEventValueInputSchema = z.object({
  attribute_id: z.uuid(),
...
export const logEntityEventInputSchema = z.object({
  entity_id: z.uuid(),
  ...
  note: z
    ...
    .nullable(),
  values: z.array(entityEventValueInputSchema).max(30),
})

// Entity and type are fixed once logged — edit only moves the when/who/values.
...
export const updateEntityEventInputSchema = logEntityEventInputSchema
  .omit({ entity_id: true, event_type_id: true })
  .extend({ attribute_ids: z.array(z.uuid()).max(30) })

export type EntityEventValueInput = z.infer<typeof entityEventValueInputSchema>
export type LogEntityEventInput = z.infer<typeof logEntityEventInputSchema>
export type UpdateEntityEventInput = z.infer<typeof updateEntityEventInputSchema>
