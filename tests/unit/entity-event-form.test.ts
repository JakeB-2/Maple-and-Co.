...
function attr(overrides: Partial<EventTypeAttributeRow>): EventTypeAttributeRow {
  return {
...
function existingValue(
  overrides: Partial<EntityEventValueRow> & Pick<EntityEventValueRow, 'attribute_id'>
): EntityEventValueRow {
  return {
    id: crypto.randomUUID(),
    value_text: null,
