// EAV value rendering for entity events (D-013) — the one place a raw
// entity_event_values row becomes a human-readable string. Server-safe.

import { attributeOptions, type EventTypeAttributeRow } from '@/lib/queries/event-types'
import type { EntityEventRow, EntityEventValueRow } from '@/lib/queries/entity-events'
import { Field } from '@/components/screens/field'

type ValuePair = { value: EntityEventValueRow; attr: EventTypeAttributeRow }
...
function valueText(value: EntityEventValueRow, attr: EventTypeAttributeRow): string | null {
